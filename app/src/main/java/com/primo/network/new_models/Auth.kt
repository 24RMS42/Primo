...
open class Auth(open var access_token: String = "",
    ...
    override fun toString(): String{
        return "Auth(access_token='$access_token', expires_in=$expires_in, user_status=$user_status, cart_id='$cart_id', creditcard_id='$creditcard_id', shipping_id='$shipping_id', country='$country')"
    }
}