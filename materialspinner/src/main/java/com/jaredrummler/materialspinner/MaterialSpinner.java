...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textColor = ta.getColor(R.styleable.MaterialSpinner_ms_text_color, Color.GRAY);
            ...
            prefixText = ta.getString(R.styleable.MaterialSpinner_ms_prefix_text);
            prefixTextColor = ta.getColor(R.styleable.MaterialSpinner_ms_prefix_text_color, Color.BLACK);
            prefixSpace = ta.getDimensionPixelSize(R.styleable.MaterialSpinner_ms_prefix_space, 0);
        } finally {
            ta.recycle();
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            popupWindow.setBackgroundDrawable(Utils.getDrawable(context, R.drawable.dialog_full_holo_light));
        }
    ...
    if (backgroundColor != Color.WHITE) { // default color is white
      setBackgroundColor(backgroundColor);
        ...
        if (prefixText != null)
            setCompoundDrawables(new TextDrawable(prefixText), null, null, null);
    }
    ...
    public void onRestoreInstanceState(Parcelable savedState) {
        if (savedState instanceof Bundle) {
            ...
            if (adapter != null) {
                ...
                if (selectedIndex >= 0 && adapter.getCount() > 0) {
    ...
    private class TextDrawable extends Drawable {
        ...
        public TextDrawable(String text) {
            mText = text;
            setBounds(0, 0, (int) getPaint().measureText(mText) + prefixSpace, (int) getTextSize());
        }
